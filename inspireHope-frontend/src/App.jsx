...
function App() {
  ...
  const handleDonateSubmit = (event) => {
    ...
    popup.newTransaction({
      ...
      onSuccess: (result) => {
        ...
        setDonationForm((currentForm) => ({ ...currentForm, amount: '50' }))
      },
      onCancel: () => {
        setIsDonationLoading(false)
        setDonationStatus({
  ...
  return (
    <div className="page-shell">
      {isWelcomeVisible ? (
        <section
          className={`welcome-screen ${isWelcomeClosing ? 'welcome-screen-leave' : ''}`}
        ...
        >
          ...
          <div className="welcome-panel">
            <div className="welcome-mark">IH</div>
            <p className="welcome-kicker">InspireHope Foundation</p>
            <h1>Welcome to InspireHope Foundation.</h1>
            <p className="welcome-text">
              We are glad you are here. Together, we are building a more welcoming
              world where everyone has a place and the opportunity to thrive.
            </p>
      ...
      <div className={`page-content ${!isWelcomeVisible ? 'page-content-ready' : ''}`}>
